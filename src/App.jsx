...
function App() {
  // const [allPets, setAllPets] = useFavorites();
      ...
      <Routes>
        <Route element={<Footer />}>
          ...
          <Route element={<LoggedIn />}>
            ...
            <Route
              path="/pets/:specie"
              element={<PageList handleAddToFavorite={handleAddToFavorite} />}
            />
            <Route
              path="/pets/specie/:petId"
              element={<PetDetails handleAddToFavorite={handleAddToFavorite} />}
            />
            <Route path="/found-a-pet" element={<FoundAPetForm />} />
            <Route path="/adopt-a-pet/:id" element={<AdoptionForm />} />
